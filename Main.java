...
public class Main {
    static void main(String[] args) {
        ...
        while (winter_weeks < 3) {
            ...
            if (temp <= 32) {
                ...
                gameID +=2;
                    ...
                    //Game 1
                    away1.setTotal_goals_scord(away1.getTotal_goals_scord() + game1.getAway_score());
                    away1.setTotal_goals_scord(away1.getTotal_goals_scord() + game1.getHome_score());
                    home1.setTotal_goals_scord(home1.getTotal_goals_scord() + game1.getAway_score());
                    home1.setTotal_goals_scord(home1.getTotal_goals_scord() + game1.getHome_score());

                    //Game 2
                    away2.setTotal_goals_scord(away2.getTotal_goals_scord() + game2.getAway_score());
                    away2.setTotal_goals_scord(away2.getTotal_goals_scord() + game2.getHome_score());
                    home2.setTotal_goals_scord(home2.getTotal_goals_scord() + game2.getAway_score());
                    home2.setTotal_goals_scord(home2.getTotal_goals_scord() + game2.getHome_score());
        ...
        System.out.print("Season is over! \n\n");
    ...
    public static void record_WLT(Game game){
        if (game.getAway_score() > game.getHome_score()){
            ...
            game.getAway().setTie_total(game.getHome().getTie_total() +1);
